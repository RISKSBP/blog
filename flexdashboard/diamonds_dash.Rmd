...
preds_glmnet <- glmnet:::predict.cv.glmnet(glmnet_model, newx = X_test) %>% as.numeric()

# get fitted values ----
fitted_vals_lm <- fitted.values(linear_model)
fitted_vals_glm <- glmnet:::predict.cv.glmnet(glmnet_model, newx = X_train) %>% as.numeric()
